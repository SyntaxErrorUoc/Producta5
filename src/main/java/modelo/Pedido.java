...
public class Pedido {
	...
	/**
	 * Definimos la relaciones con la clase Articulo y Pedido.
	 */
	 ...
	 * @return valor double que refleja el coste de envío.
	 */
	...
	/**
	 * Método que establece el valor del coste de envío
	 * @param costeenvio double con el valor del coste del envío
	 */
	...
	/**
	 * Método para que enviado nos muestre un String y no un boolean
	 * @return devuelve un String
	 */
	...
	/**
	 * Método para mostrar por pantalla el pedido.
